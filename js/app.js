    ...
    function showMore() {
        window.addEventListener("load", (function(e) {
            ...
            function initItem(showMoreBlock, matchMedia = false) {
                ...
                const showMoreTypeValue = showMoreContent.dataset.showmoreContent ? parseInt(showMoreContent.dataset.showmoreContent, 10) : 3;
                if (showMoreItems.length <= showMoreTypeValue) {
                    _slideDown(showMoreContent, 0, showMoreContent.offsetHeight);
 ...
 */    var MEDIA_PREFERS_REDUCED_MOTION = "(prefers-reduced-motion: reduce)";
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        var feedbackSliderEl = document.querySelector(".feedback__slider");
        if (feedbackSliderEl) {
            var feedbackSlider = new Splide(feedbackSliderEl, {
                perPage: 3,
                arrows: false,
                pagination: true,
                gap: 44,
        ...
        var blogSliderEl = document.querySelector(".blog__slider");
        if (blogSliderEl) {
            var sliderOptions = {
                perPage: 3,
                arrows: false,
            ...
            if (blogSliderEl.classList.contains("blog__slider--home")) sliderOptions.destroy = true;
            var blogSlider = new Splide(blogSliderEl, sliderOptions);
            blogSlider.mount();
        }
        var bundllesSliderEl = document.querySelector(".bundles__slider");
        if (bundllesSliderEl) {
            var bundlesSlider = new Splide(bundllesSliderEl, {
                perPage: 3,
                arrows: false,
                pagination: false,
                updateOnMove: true,
